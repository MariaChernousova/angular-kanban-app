...
function addDependenciesAndScripts() {
    return (host) => {
        ...
        pkg.scripts = Object.assign({}, pkg.scripts, { 'prebuild:ssr': `ngcc` });
...
function addFiles(options) {
    return (tree, _context) => __awaiter(this, void 0, void 0, function* () {
        ...
        const rule = schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files/root'), [
            schematics_1.template(Object.assign({}, core_1.strings, options, { stripTsExtension: (s) => s.replace(/\.ts$/, ''), getBrowserDistDirectory: () => browserDistDirectory, getServerDistDirectory: () => SERVER_DIST, getClientProjectName: () => options.clientProject })),
